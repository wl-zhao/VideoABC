...
_C.VIDEOABC = CfgNode()
_C.VIDEOABC.ENABLE = True
_C.VIDEOABC.USE_INTRA = True
_C.VIDEOABC.USE_EMBED = True
_C.VIDEOABC.SLOW_ONLY = False
_C.VIDEOABC.PRETRAINED = None
...
# Model architecture.
_C.MODEL.ARCH = "slowfast_hdr"

# Model name
_C.MODEL.MODEL_NAME = "SlowFast_HDR"
...
_C.MODEL.MULTI_PATHWAY_ARCH = ["slowfast", "slowfast_hdr"]

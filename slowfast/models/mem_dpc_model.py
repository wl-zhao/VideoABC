...
class resnet34_2d3d_full(nn.Module):
    def __init__(self, cfg, **kwargs):
        super().__init__()
        self.backbone = ResNet2d3d_full([BasicBlock2d, BasicBlock2d, BasicBlock3d, BasicBlock3d],
                   [3, 4, 6, 3], **kwargs)
        if cfg.VIDEOABC.PRETRAINED:
            a, b = self.load_state_dict(torch.load(cfg.VIDEOABC.PRETRAINED)['state_dict'], strict=False)
